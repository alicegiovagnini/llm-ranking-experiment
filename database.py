...
def insert_user_results_to_db(session, initial_correlation, final_correlation, improvement,username,partner,in_accordo,weight_of_advice=None, average_feedback=None):
    if(username == ""):
        username = None
    if(partner == ""):
        partner = None
